    ...
    <div className="w-full min-h-screen shadow-md bg-gray-800 px-1 hidden md:block">
      ...
      <ul className="relative mt-4">
        <li className="relative px-2">
          <a className="flex uppercase items-center text-sm py-4 px-6 h-12 font-open-sans overflow-hidden text-gray-200 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-blue-100 hover:font-medium hover:rounded-lg transition duration-300 ease-in-out" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="dark">
