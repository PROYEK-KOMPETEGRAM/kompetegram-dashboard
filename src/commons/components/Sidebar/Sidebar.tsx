    ...
    <div className="w-full min-h-screen shadow-md bg-gray-800 px-1 hidden md:block">
      ...
      <ul className="relative mt-4">
        <li className="relative px-2">
          <Link to="/dashboard/stats" className="flex uppercase mt-1.5 font-medium items-center text-sm py-4 px-6 h-12 font-open-sans overflow-hidden text-gray-50 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-blue-100 hover:font-semibold hover:rounded-lg transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="dark">
        ...
        <li className="relative px-2">
          <Link to="/dashboard/members" className="flex uppercase mt-1.5 font-medium items-center text-sm py-4 px-6 h-12 font-open-sans overflow-hidden text-gray-50 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-blue-100 hover:font-semibold hover:rounded-lg transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="dark">
